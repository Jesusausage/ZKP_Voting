SRC = src/ECGroup.cpp src/SigmaProtocol.cpp src/Transcript.cpp src/ElGamalProtocol.cpp src/SchnorrProtocol.cpp src/OrProtocol.cpp src/OrTranscript.cpp src/Voter.cpp src/Vote.cpp src/KeyGen.cpp src/Key.cpp src/Verifier.cpp src/VoteData.cpp src/TCPServer.cpp src/TCPClient.cpp src/TCPConnection.cpp
